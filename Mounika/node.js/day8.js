...
async function main() {
    try {
        ...
        await students.insertMany([
            { rollno: 101, name: "Mounika", branch: "CSE", year: 2 },
            { rollno: 102, name: "Siri", branch: "ECE", year: 3 },
            { rollno: 103, name: "Teja", branch: "EEE", year: 1 },
            { rollno: 104, name: "Anu", branch: "CSE", year: 4 },
            { rollno: 105, name: "Ravi", branch: "MECH", year: 2 }
        ]);
